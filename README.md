...
may be possible in the future. The library currently supports STM32 microcontrollers and
provides a [simple interface](https://docs.rs/emcyphal-driver/) for adding new drivers.
...
* [`emcyphal`](https://docs.rs/emcyphal/) -
  Cyphal stack implementation; provides the API for user code.
* [`emcyphal-data-types`](https://docs.rs/emcyphal-data-types/) -
  Auto-generated Cyphal public regulated data types.
  Maintained in a separate [repository](https://github.com/dan-stefanov/emcyphal-data-types-generated).
* [`emcyphal-stm32-native`](https://docs.rs/emcyphal-stm32-native/) - 
  STM32 FDCAN driver.
* [`emcyphal-stm32-embassy`](https://docs.rs/emcyphal-stm32-embassy/) - 
  Embassy STM32 FDCAN driver adapter.

## Getting started

Check the [`nucleo-g431rb`](nucleo-g431rb) example project to get started. You can run it 
immediately if you have the board. Otherwise, adapt it to your hardware by adjusting the chip name,
crystal frequency, and output pins.
