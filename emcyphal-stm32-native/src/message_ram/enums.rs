// This file is copied and modified from fdcan repository https://github.com/stm32-rs/fdcan
...
pub enum FilterFrameMatch {
    /// This did match filter with specific id
    DidMatch(u8),
...
pub enum FilterType {
    ...
    ClassicFilter = 0b10,
    /// Filter is disabled
    FilterDisabled = 0b11, // TODO: incorrect for G4, check for H7
}
